...
class Order(models.Model):
    ...
    first_name_customer = models.CharField( max_length=64, verbose_name='Имя покупателя',null=True)
    last_name_customer = models.CharField( max_length=64, verbose_name='Фамилия покупателя',null=True)
    deliverytype = models.CharField( max_length=64, verbose_name='Cпособ доставки',null=True)
